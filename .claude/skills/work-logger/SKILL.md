...
allowed-tools:
  - mcp__agent-human-log__log_milestone
...
Call `mcp__agent-human-log__log_milestone` at these natural breakpoints:
...
At the beginning of each session, call `mcp__agent-human-log__get_yesterday` to load context from the previous day. Use this to understand ongoing work and carry-forward items. Do not announce the results unless the developer asks.
